...
#+RESULTS: my/date-is-yesterday
: my/date-is-yesterday
...
#+RESULTS:
| org-tempo-setup | my/org-mode-hook | org-auto-tangle-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | #[0 \301\211\207 [imenu-create-index-function org-imenu-get-tree] 2] |
...
#+RESULTS:
: Personal library section time:       0.33s
...
#+RESULTS:
| (lambda nil (add-to-list 'TeX-command-list '(XeLaTeX %`xelatex%(mode)%' %t TeX-run-TeX nil t)) (setq TeX-command-default XeLaTeX)) | preview-mode-setup |
